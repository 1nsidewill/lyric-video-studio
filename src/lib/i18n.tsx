...
const ko = {
  ...
  // Sketch
  'nav.sketch': '스케치',
  'home.sketch.title': '스케치',
  'home.sketch.desc': 'DAW 없이 비트 위에 바로 펀치인 — 체인·페이더는 내가 잡아줄게',
  'sk.title': '스케치',
  'sk.sub': '비트 골라서 REC — 멈블이든 프리스타일이든, 나머지는 내가 해줄게',
  'sk.new': '새 스케치',
  'sk.pickLibrary': '보관함에서 고르기',
  'sk.pickFile': '파일에서 고르기',
  'sk.noBeats': '보관함이 비어 있어요 — 다운로더에서 비트를 받아오거나 파일로 시작하세요',
  'sk.sessions': '내 스케치',
  'sk.emptySessions': '아직 스케치가 없어요.\n비트 하나 골라서 첫 테이크를 남겨보세요.',
  'sk.open': '열기',
  'sk.delete': '삭제',
  'sk.rec': 'REC',
  'sk.stop': '정지',
  'sk.recHint': 'REC를 누르면 비트가 흐르면서 바로 녹음돼요',
  'sk.recording': '녹음 중',
  'sk.takes': '테이크',
  'sk.take': '테이크',
  'sk.emptyTakes': '아직 테이크가 없어요 — REC!',
  'sk.tone': '톤',
  'sk.micDenied': '마이크 권한이 필요해요. 시스템 설정 → 개인정보 보호 → 마이크에서 허용해 주세요.',
  'sk.back': '내 스케치',
  'sk.kbd': 'Space 재생/정지 · R 녹음',
...
const en: Record<DictKey, string> = {
  ...
  'nav.sketch': 'Sketch',
  'home.sketch.title': 'Sketch',
  'home.sketch.desc': 'Punch in over a beat without a DAW — chain & faders handled',
  'sk.title': 'Sketch',
  'sk.sub': 'Pick a beat and hit REC — mumble or freestyle, I’ll do the rest',
  'sk.new': 'New sketch',
  'sk.pickLibrary': 'From library',
  'sk.pickFile': 'From file',
  'sk.noBeats': 'Library is empty — grab beats in the Downloader or start from a file',
  'sk.sessions': 'My sketches',
  'sk.emptySessions': 'No sketches yet.\nPick a beat and lay down a first take.',
  'sk.open': 'Open',
  'sk.delete': 'Delete',
  'sk.rec': 'REC',
  'sk.stop': 'Stop',
  'sk.recHint': 'Hit REC — the beat rolls and recording starts',
  'sk.recording': 'Recording',
  'sk.takes': 'Takes',
  'sk.take': 'Take',
  'sk.emptyTakes': 'No takes yet — hit REC!',
  'sk.tone': 'Tone',
  'sk.micDenied': 'Microphone permission needed. Allow it in System Settings → Privacy → Microphone.',
  'sk.back': 'My sketches',
  'sk.kbd': 'Space play/pause · R record',
