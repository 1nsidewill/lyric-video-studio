        ...
        {dragging && (
          <motion.div
            ...
            <motion.div initial={{ scale: 0.96 }} animate={{ scale: 1 }}
              ...
              style={{ border: '2px dashed rgba(255,255,255,0.25)', background: 'rgba(255,255,255,0.03)' }}>
              <div className="text-5xl mb-3">🎵🎨</div>
              <p className="text-lg font-bold tracking-wide" style={{ fontFamily: 'var(--font-display)', color: 'var(--color-text-primary)' }}>
                여기에 놓으세요
              </p>
